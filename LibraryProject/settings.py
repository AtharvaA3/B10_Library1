...
config.read(r'C:\Python B10\file_handling_practice\Django_Projects\Practice1\LibraryProject\LibraryProject\project.conf')
# C:\Python B10\file_handling_practice\Django_Projects\Practice1\LibraryProject\LibraryProject
